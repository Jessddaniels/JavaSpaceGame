...
public class ScreenManager {
	...
	JFrame f;
	//give graphics card access to monitor
	...
	//compares DM passed in to vc DM and see if the match
	...
	public void setFullScreen(DisplayMode dm) {
		f = new JFrame();
		f.setUndecorated(true);//no title bars or scroll bars
	...
	//we will set Graphics object = to return
